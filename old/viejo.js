    ...
    return (
      <Fragment>
        ...
        <View style={{flex:2,alignItems: 'center'}}>
            <Text style={{fontSize: 20,textAlign: 'center'}}> 'wololoo' </Text>
        ...
        <View
            ...
            <MyButton onPress={this.handleOnPress}> </MyButton>
        </View> 
        <View style={{flex:2,alignItems:'center'}}>
           {this.state.isVisible && (<Image style={{width: 100, height: 100,alignSelf:'center'}} source={Imagen} />)}
        </View>
      </SafeAreaView>
      </Fragment>
    );
